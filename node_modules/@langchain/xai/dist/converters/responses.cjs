...
function convertStreamEventToChunk(event) {
	...
	if (event.type === "response.output_text.delta") return new _langchain_core_outputs.ChatGenerationChunk({
		text: event.delta,
...
//#endregion
exports.convertMessageToResponsesInput = convertMessageToResponsesInput;
...
exports.convertUsageToUsageMetadata = convertUsageToUsageMetadata;
