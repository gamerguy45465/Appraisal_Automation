...
function convertStandardContentMessageToGeminiContent(message, messages) {
	...
	if (AIMessage.isInstance(message) && message.tool_calls?.length) for (const toolCall of message.tool_calls) {
	...
	*/
	...
	function baseGeminiPart() {
		if (typeof item === "string") return { text: item };
			...
			else if (isDataContentBlock(item)) return convertToProviderContentBlock(item, geminiContentBlockConverter);
