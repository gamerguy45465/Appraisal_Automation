...
// [L3] Imports compile-time types ChatGoogle from @langchain/google for the Google Gemini chat model adapter.
import type { ChatGoogle } from '@langchain/google';
// [L4] Imports compile-time types ChatXAI from @langchain/xai for the xAI Grok chat model adapter.
...
// [L13] Defines the union of supported provider-specific chat model classes.
