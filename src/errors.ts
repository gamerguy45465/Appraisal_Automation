// [L1] Imports compile-time types AiProvider from ./domain.js for shared validated application data, business rules, defaults, and domain types.
...
// [L9] Closes the scope or expression introduced here: Defines the application error class used to carry deliberately public messages and error metadata.
}
