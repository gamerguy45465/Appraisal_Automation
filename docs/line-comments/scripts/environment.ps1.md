# Line explanations: scripts/environment.ps1

Source: [scripts/environment.ps1](../../../scripts/environment.ps1). Numbers refer to the original file before comments were added.
